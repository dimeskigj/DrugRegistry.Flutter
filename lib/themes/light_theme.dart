...
const _secondaryColor = Color(0xFF06b6d4);
...
final lightTheme = ThemeData(
  ...
  textTheme: _baseTheme.textTheme.copyWith(
    ...
    labelLarge: _baseTheme.textTheme.labelLarge!.copyWith(color: _textColor),
    labelMedium: _baseTheme.textTheme.labelMedium!.copyWith(color: _textColor),
    labelSmall: _baseTheme.textTheme.labelSmall!.copyWith(color: _textColor),
  ),
