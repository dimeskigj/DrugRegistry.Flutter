...
double getDistanceBetweenLocations(Location l1, Location l2) {
  final longitude = l1.longitude, otherLongitude = l2.longitude, latitude = l1.latitude, otherLatitude = l2.latitude;
  ...
  final d3 = pow(sin((d2 - d1) / 2.0), 2.0) + cos(d1) * cos(d2) * pow(sin(num2 / 2.0), 2.0);
